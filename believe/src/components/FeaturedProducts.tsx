...
export const FeaturedProducts = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      price: 89.99,
      image:
        'https://images.unsplash.com/photo-1612196808214-b8e1d6145a8c?q=80&w=1974&auto=format&fit=crop',
      category: 'Decor',
    },
    {
      id: 4,
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            Explore our latest collection of innovative designs that push the
